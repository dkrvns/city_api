...
from city_api.infrastructure.grpc.district import district_pb2
from city_api.infrastructure.grpc.district.district_pb2_grpc import DistrictServiceServicer
